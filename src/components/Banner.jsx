...
const Banner = () => {
    return (
        <>
            <div className="bg-[#F2F0FF] h-[764px] w-full">
                <Container>
                    <div className="flex w-[100%] justify-between">
                        ...
                        <div className="w-[45%]">
                            <h5 className='mt-[200px] font-jsans text-[#FB2E86] text-[16px]'>Best Furniture For Your Castle....</h5>
                            ...
                            <h4 className='font-jsans text-center text-[white] py-[10px] w-[150px] text-[17px] bg-[#FB2E86]'>Shop Now</h4>
                        </div>
                        <div className="w-[35%]">
